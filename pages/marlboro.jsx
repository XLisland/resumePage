...
import marlboro2 from'../public/assets/Marlboro.png'
    ...
    return (
        <div className='w-full'>
            <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
                ...
                <Image className='absolut z-1' layout='fill' objectFit ='cover'  src={marlboro2} alt='/' />
                <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
                    <h2 className='py-2'>Marlboro Membership</h2>
            ...
            <div className='col-span-4'>
                ...
                <p className='py-4'>
                    ...
                    Users are able to use itt for tobacco-purchasing with a membership discount.
                    And our community support people share with their experience on different products.
                </p>
